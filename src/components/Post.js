...
function Post() {
  return (
    <div className="mt-6 mb-6 post_container">
      ...
      <main className="sm:text-base text-sm">
      ...
      <div className="flex justify-between mx-4 text-[#65676b] py-2 border-solid border-b-2 border-gray-300 sm:text-base text-xs">
        <div>1.8 พัน</div>
        <div className="flex">
